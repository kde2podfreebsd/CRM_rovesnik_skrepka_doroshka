...
from BackendApp.TelegramBots.Doroshka.Handlers.affilate_promotions_handler import (
    affilate_promotions,
    promotion_get_reward
)
from BackendApp.TelegramBots.Doroshka.Handlers.faq_handler import (
    help_menu
)
from BackendApp.TelegramBots.Doroshka.Handlers.invoice_handler import *
from BackendApp.TelegramBots.Doroshka.Handlers.invoice_handler import (
    invoice_menu,
    payment1000,
    payment2500,
...
from BackendApp.TelegramBots.Doroshka.Handlers.menu_handler import send_menu
from BackendApp.TelegramBots.Doroshka.Handlers.partner_gift_handler import (
    get_free_promocode_menu,
    get_partner_gift_menu,
    partner_gift_menu,
)
from BackendApp.TelegramBots.Doroshka.Handlers.profile_handler import profile_menu
from BackendApp.TelegramBots.Doroshka.Handlers.promocodes_handler import (
    activated_promocode_menu,
    promocode_menu,
)
from BackendApp.TelegramBots.Doroshka.Handlers.promotions_handler import promotions
from BackendApp.TelegramBots.Doroshka.Handlers.referrals_handler import (
    invite_friend,
    referrers_menu,
)
from BackendApp.TelegramBots.Doroshka.Handlers.review_handler import (
    review_menu,
    review_menu_bar,
    review_menu_event,
...
from BackendApp.TelegramBots.Doroshka.Handlers.support_handler import (
    MyStates,
    add_agent,
    add_message,
    all_agents,
...
from BackendApp.TelegramBots.Doroshka.Handlers.test_handler import (
    get_award_for_test,
    test,
)
from BackendApp.TelegramBots.Doroshka.Handlers.tx_handler import transactions_menu

BAR_ID = 3 # this param should be changed when expanding functionallity on all 3 bots
