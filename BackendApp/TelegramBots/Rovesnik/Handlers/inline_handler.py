...
from BackendApp.TelegramBots.Rovesnik.Handlers.affilate_promotions_handler import (
    affilate_promotions,
    promotion_get_reward
)
from BackendApp.TelegramBots.Rovesnik.Handlers.faq_handler import (
    help_menu
)
from BackendApp.TelegramBots.Rovesnik.Handlers.invoice_handler import *
from BackendApp.TelegramBots.Rovesnik.Handlers.invoice_handler import (
    invoice_menu,
    payment1000,
    payment2500,
...
from BackendApp.TelegramBots.Rovesnik.Handlers.main_menu_handler import main_menu
from BackendApp.TelegramBots.Rovesnik.Handlers.menu_handler import send_menu
from BackendApp.TelegramBots.Rovesnik.Handlers.partner_gift_handler import (
    get_free_promocode_menu,
    get_partner_gift_menu,
    partner_gift_menu,
)
from BackendApp.TelegramBots.Rovesnik.Handlers.profile_handler import profile_menu
from BackendApp.TelegramBots.Rovesnik.Handlers.promocodes_handler import (
    activated_promocode_menu,
    promocode_menu,
)
from BackendApp.TelegramBots.Rovesnik.Handlers.promotions_handler import promotions
from BackendApp.TelegramBots.Rovesnik.Handlers.referrals_handler import (
    invite_friend,
    referrers_menu,
)
from BackendApp.TelegramBots.Rovesnik.Handlers.review_handler import (
    review_menu,
    review_menu_bar,
    review_menu_event,
...
from BackendApp.TelegramBots.Rovesnik.Handlers.support_handler import (
    MyStates,
    add_agent,
    add_message,
    all_agents,
...
from BackendApp.TelegramBots.Rovesnik.Handlers.test_handler import (
    get_award_for_test,
    test,
)
from BackendApp.TelegramBots.Rovesnik.Handlers.tx_handler import transactions_menu
