...
export default class TablesService {
  ...
  static async getBowling(): Promise<AxiosResponse<ITable[]>> {
    return $api.get('/table/get_bowling')
  }

  static async getPool(): Promise<AxiosResponse<ITable[]>> {
    return $api.get('/table/get_pool')
  }
