...
export default class ReservationService {
  ...
  static async checkAbility(
    ...
    return $api.post(`/reservation/check_change_ability?reserve_id=${reserve_id}`)
  }
  ...
  static async getByOrderUUIDWithTables(order_uuid: string) {
    return $api.get('/reservation/get_reservation_and_table_by_order_uuid/' + order_uuid)
  }
}
