        ...
        <div className={`${styles.root} ${rootClassName}`}>
            <div className={styles.container}>
                <div className={styles.headerLogo}>
                    <Link to={type === 'afisha' ? `/doroshka/?barId=${barId}` : `/doroshka/reservation?barId=${barId}`}>
                ...
                <div className={styles.headerNav}>
                    ...
                    <Link to={type === 'afisha' ? `/doroshka/my/events?barId=${barId}` : `/doroshka/my/reservations?barId=${barId}`}>
