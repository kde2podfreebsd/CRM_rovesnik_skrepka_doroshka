...
const ReserveTablePage = () => {
  ...
  const reserveTable = async (values: any) => {
    ...
    try {
      ...
      navigate('/rovesnik/my/reservations?barId=1')
    } catch (e) {
      console.log(e)
    }
  }
  ...
  const handleClose = () => {
    setIsOpen(false)
    if (currentStep === 2) navigate('/rovesnik/my/reservations?barId=1')
  }
        ...
        <div className={`${styles.root} ${rootClassName}`}>
          ...
          <div className={`${styles.main} ${mainClassName1}`}>
            ...
            <div style={{ display: 'flex', flexDirection: 'column' }}>
              ...
              <img src={floorImages[selectedFloor - 1]} alt=""/>
              {availableTables.length > 0 && availableTables ? (
                        ...
                        {({ handleSubmit }) => (
                            <Form onSubmit={handleSubmit}>
                              ...
                              <div className={styles.formFieldInfo}>
                                ...
                                />
                                {
                                  phoneError && <p className="text-red-500">Неверный формат номера телефона. <br/>  Например: +79999999999</p>
                                }
                                {
